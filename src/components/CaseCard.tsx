                ...
                {data.source_urls.length > 0 ? (
                    data.source_urls.map((source, index) => (
                        <a
                            ...
                            className="text-[11px] font-semibold text-primary-blue hover:text-blue-700 hover:underline flex items-center gap-1 transition-colors uppercase tracking-wide"
                        >
                            {source.name} &rarr;
                        </a>
                    ))
